...
<form style="text-align: center" id="form-search" class="form-search" action="" method="get">
  <input type="search" class="input-medium search-query" id="search-box" placeholder="搜点什么..." name="q">
...
function displaySearchResults(has_search_text, results, pages) {
	...
	if (results.length && has_search_text) {
		...
		el_search_results.innerHTML = '<p><em>未找到结果</em></p>';
	} else {
		el_search_results.innerHTML = '<p><em>请在上方输入搜索词</em></p>';
	}
}
